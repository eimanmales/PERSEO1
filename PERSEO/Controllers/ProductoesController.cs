...
namespace PERSEO.Controllers
{
    ...
    public class ProductoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Codigo,Nombre,Precio,Stock")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Codigo,Nombre,Precio,Stock")] Producto producto)
        {
